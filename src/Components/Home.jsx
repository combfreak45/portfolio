...
const Home = () => {
  return (
    <div className=" relative lg:pt-20 lg:px-20 h-screen">
      <img
        src={home}
        alt="sdcs"
        className=" top-[5rem] left-10  w-[20rem] h-[20rem]  lg:h-[30rem] lg:w-[30rem]  lg:top-3 lg:left-[40rem] absolute z-10"
      />
      <div className=" w-[18rem] h-[18rem] top-[25rem] left-[3rem] p-10 lg:w-[20rem] lg:h-[20rem] lg:left-[10rem]  absolute lg:top-[13rem] z-10 lg:p-10 center bg-[#343434]     rounded-2xl  text-white lg:text-xl shadow-lg shadow-black">
        <h1 className="text-[1.5rem] lg:text-4xl  font-extrabold lg:pb-2 font-rubik-500">
          ARJIT KEDIA
        </h1>
        <div className=" text-[1rem] lg:text-3xl lg:py-5">
          <TypeAnimation
        ...
        <p className="text-[.7rem] lg:text-sm pt-2">
          Third year student at NIT Kurukshetra{" "}
        </p>
        <p className="text-[.5rem] lg:text-sm">Work with passion and dedication</p>
        <div className="flex flex-row gap-1 lg:gap-2 mt-5 ">
          <a
            href="https://www.instagram.com/nothing_23_why/"
            target="_blank"
            className=" opacity-60 hover:opacity-100 hover:scale-125 size-10"
          >
            <svg
              className="w-10 h-10"
          ...
          <a
            href="https://www.behance.net/arjitkedia"
            target="_blank"
            className=" opacity-60 hover:opacity-100 hover:scale-125"
          >
            <svg
              className="w-10 h-10"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://github.com/combfreak45"
            target="_blank"
            className=" opacity-60 hover:opacity-100 hover:scale-125"
          >
            <svg
          ...
          <a
            href="https://www.linkedin.com/in/arjit-kedia-06041a236/"
            target="_blank"
            className=" opacity-60 hover:opacity-100 hover:scale-125"
          >
            <svg
      ...
      {/* <div className="absolute z-4 h-[6rem] w-[6rem] rounded-full bg-red-500 top-1 left-[10rem] p-7 font-medium text-white text-3xl">
        Hi!
      </div> */}
      {/* <div className='absolute z-5 right-1 top-1 '>
        <BouncingBall />
      </div> */}
      <div className="text-[4.5rem] bottom-[4rem] left-5 sm:text-[4rem] lg:text-[8rem] font-bold lg:bottom-0 absolute lg:left-[40rem]">
        DESIGNER
      </div>
      <div className="text-[4.5rem] top-[1rem]  lg:text-[8rem] font-bold lg:top-0 absolute lg:left-10">
        DEVELOPER
      </div>
    </div>
  );
